...
- Network helper installation is disabled until the user chooses **Enable network helpers** (or explicitly sets `NEUTRASEARCH_AUTO_PROVISION_REMOTE`). It runs SSH/SCP and modifies the selected remote user's application-data directory.
